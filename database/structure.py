...
class Words(Base):
    ...
    """
    words - таблица с информацией по английским словам.
    ...
    добавление слова пользоователем (True - слово добавлено
    пользователем, False - наоборот)
    """
...
class UsersWords(Base):
    ...
    слова (True - слово добавлено, False - слово удалено)
    - is_user_word: показывает принадлежность слова
    пользователю (True - пользователь сам добавил это слово,
    False - пользователь не имеет отношения к добавлению слова)
